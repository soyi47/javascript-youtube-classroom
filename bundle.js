...
var HomeView = /*#__PURE__*/_createClass(function HomeView(_ref) {
  var _this = this;
...
var SavedVideoListView = /*#__PURE__*/_createClass(function SavedVideoListView(_ref) {
  var _this = this;
  ...
  _defineProperty(this, "updateOnUnwatchedVideoList", function (e) {
    ...
    if (response !== _constants__WEBPACK_IMPORTED_MODULE_0__.RESULT.SUCCESS) {
      (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#unwatched-video-list').innerHTML = _template__WEBPACK_IMPORTED_MODULE_2__.template.failToReadSavedVideo;
      return;
    }

    if (unwatchedVideos.length === 0) {
      (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#unwatched-video-list').innerHTML = _template__WEBPACK_IMPORTED_MODULE_2__.template.noUnwatchedVideo;
      return;
    }
  ...
  _defineProperty(this, "updateOnWatchedVideoList", function (e) {
    ...
    if (response !== _constants__WEBPACK_IMPORTED_MODULE_0__.RESULT.SUCCESS) {
      (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#watched-video-list').innerHTML = _template__WEBPACK_IMPORTED_MODULE_2__.template.failToReadSavedVideo;
      return;
    }

    if (watchedVideos.length === 0) {
      (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#watched-video-list').innerHTML = _template__WEBPACK_IMPORTED_MODULE_2__.template.noWatchedVideo;
      return;
    }
  ...
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#app').addEventListener(_constants__WEBPACK_IMPORTED_MODULE_0__.EVENT.UPDATE_SAVED_VIDEO_LIST, this.updateOnSavedVideoList);
});
...
var SearchKeywordFormView = /*#__PURE__*/_createClass(function SearchKeywordFormView(_ref) {
  var _this = this;
  ...
  (0,_util__WEBPACK_IMPORTED_MODULE_0__.$)('#search-form').addEventListener('submit', this.onSubmitSearchForm);
});
...
var SearchModalView = /*#__PURE__*/_createClass(function SearchModalView(_ref) {
  var _this = this;
...
var SearchResultView = /*#__PURE__*/_createClass(function SearchResultView(_ref) {
  var _this = this;
  ...
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.$)('#modal-container').addEventListener(_constants__WEBPACK_IMPORTED_MODULE_0__.EVENT.UPDATE_SEARCH_STATE, this.updateOnSearchState);
});
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\r\n  padding: 64px 0;\r\n  font-size: 16px;\r\n}\r\n\r\n#app {\r\n  max-width: 1020px;\r\n  margin: 0 auto;\r\n}\r\n\r\n.classroom-container__title {\r\n  text-align: center;\r\n  font-weight: bold;\r\n  line-height: 36px;\r\n  font-size: 24px;\r\n  margin-bottom: 50px;\r\n}\r\n\r\n.nav {\r\n  display: flex;\r\n  justify-content: center;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.button {\r\n  cursor: pointer;\r\n  border-radius: 4px;\r\n  border: none;\r\n  font-style: normal;\r\n  font-weight: bold;\r\n  font-size: 14px;\r\n  letter-spacing: 1.25px;\r\n}\r\n\r\n.border-radius-left {\r\n  border-radius: 4px 0 0 4px;\r\n}\r\n\r\n.border-radius-right {\r\n  border-radius: 0 4px 4px 0;\r\n}\r\n\r\n.nav__button {\r\n  width: 80px;\r\n  height: 36px;\r\n  background: #f5f5f5;\r\n}\r\n\r\n.nav__button:hover {\r\n  background: #ebebeb;\r\n}\r\n\r\n.nav__button.selected {\r\n  background: rgba(0, 188, 212, 0.12);\r\n}\r\n\r\n.nav__button.selected:hover {\r\n  background: rgba(0, 188, 212, 0.2);\r\n}\r\n\r\n.video-list-button {\r\n  width: 117px;\r\n  border: 1px solid rgba(0, 0, 0, 0.12);\r\n}\r\n\r\n.search-button {\r\n  margin-left: auto;\r\n}\r\n\r\n.check-icon-button {\r\n  margin-left: 160px;\r\n}\r\n\r\n.icon-button {\r\n  width: 36px;\r\n  height: 36px;\r\n  background: #f5f5f5;\r\n}\r\n\r\n.icon-button:hover {\r\n  background: #ebebeb;\r\n}\r\n\r\n.icon-button.selected {\r\n  background: rgba(0, 188, 212, 0.12);\r\n}\r\n\r\n.icon-button.selected:hover {\r\n  background: rgba(0, 188, 212, 0.2);\r\n}\r\n\r\n.align-center {\r\n  margin-left: auto;\r\n  margin-right: auto;\r\n}\r\n\r\n.classroom-container {\r\n  width: 90vw;\r\n  height: 36px;\r\n}\r\n\r\n.video-list {\r\n  width: 100%;\r\n  display: grid;\r\n  grid-template-columns: repeat(1, 1fr);\r\n  gap: 32px 20px;\r\n}\r\n\r\n.video-list.search {\r\n  height: 493px;\r\n  overflow-y: scroll;\r\n}\r\n\r\n.video-item {\r\n  position: relative;\r\n  width: 240px;\r\n  height: 255px;\r\n  align-self: center;\r\n  justify-self: center;\r\n}\r\n\r\n.video-item__thumbnail {\r\n  width: 100%;\r\n  height: 135px;\r\n}\r\n\r\n.video-item__title {\r\n  font-weight: bold;\r\n  font-size: 16px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  margin: 4px 0;\r\n}\r\n\r\n.video-item__channel-name {\r\n  font-size: 16px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n}\r\n\r\n.video-item__published-date {\r\n  font-size: 12px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n}\r\n\r\n.video-item__save-button {\r\n  position: absolute;\r\n  right: 0;\r\n  width: 80px;\r\n  height: 36px;\r\n  background: #f9f9f9;\r\n  margin-top: 4px;\r\n}\r\n\r\n.video-item__save-button:hover {\r\n  background: #efefef;\r\n}\r\n\r\n@media only screen and (min-width: 400px) {\r\n  .classroom-container {\r\n    width: 368px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 600px) {\r\n  .classroom-container {\r\n    width: 500px;\r\n  }\r\n  .classroom-container__title {\r\n    font-size: 34px;\r\n    margin-bottom: 56px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(2, 1fr);\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 960px) {\r\n  .classroom-container {\r\n    width: 760px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(3, 1fr);\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1280px) {\r\n  .classroom-container {\r\n    width: 1020px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(4, 1fr);\r\n  }\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/css/app.css"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,iBAAiB;EACjB,eAAe;EACf,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;EAClB,iBAAiB;EACjB,eAAe;EACf,sBAAsB;AACxB;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,YAAY;EACZ,qCAAqC;AACvC;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,WAAW;EACX,aAAa;EACb,qCAAqC;EACrC,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,kBAAkB;EAClB,oBAAoB;AACtB;;AAEA;EACE,WAAW;EACX,aAAa;AACf;;AAEA;EACE,iBAAiB;EACjB,eAAe;EACf,iBAAiB;EACjB,qBAAqB;EACrB,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;EACvB,aAAa;AACf;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,qBAAqB;EACrB,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,qBAAqB;AACvB;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,WAAW;EACX,YAAY;EACZ,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE;IACE,YAAY;EACd;AACF;;AAEA;EACE;IACE,YAAY;EACd;EACA;IACE,eAAe;IACf,mBAAmB;EACrB;EACA;IACE,qCAAqC;EACvC;AACF;;AAEA;EACE;IACE,YAAY;EACd;EACA;IACE,qCAAqC;EACvC;AACF;;AAEA;EACE;IACE,aAAa;EACf;EACA;IACE,qCAAqC;EACvC;AACF","sourcesContent":["body {\r\n  padding: 64px 0;\r\n  font-size: 16px;\r\n}\r\n\r\n#app {\r\n  max-width: 1020px;\r\n  margin: 0 auto;\r\n}\r\n\r\n.classroom-container__title {\r\n  text-align: center;\r\n  font-weight: bold;\r\n  line-height: 36px;\r\n  font-size: 24px;\r\n  margin-bottom: 50px;\r\n}\r\n\r\n.nav {\r\n  display: flex;\r\n  justify-content: center;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.button {\r\n  cursor: pointer;\r\n  border-radius: 4px;\r\n  border: none;\r\n  font-style: normal;\r\n  font-weight: bold;\r\n  font-size: 14px;\r\n  letter-spacing: 1.25px;\r\n}\r\n\r\n.border-radius-left {\r\n  border-radius: 4px 0 0 4px;\r\n}\r\n\r\n.border-radius-right {\r\n  border-radius: 0 4px 4px 0;\r\n}\r\n\r\n.nav__button {\r\n  width: 80px;\r\n  height: 36px;\r\n  background: #f5f5f5;\r\n}\r\n\r\n.nav__button:hover {\r\n  background: #ebebeb;\r\n}\r\n\r\n.nav__button.selected {\r\n  background: rgba(0, 188, 212, 0.12);\r\n}\r\n\r\n.nav__button.selected:hover {\r\n  background: rgba(0, 188, 212, 0.2);\r\n}\r\n\r\n.video-list-button {\r\n  width: 117px;\r\n  border: 1px solid rgba(0, 0, 0, 0.12);\r\n}\r\n\r\n.search-button {\r\n  margin-left: auto;\r\n}\r\n\r\n.check-icon-button {\r\n  margin-left: 160px;\r\n}\r\n\r\n.icon-button {\r\n  width: 36px;\r\n  height: 36px;\r\n  background: #f5f5f5;\r\n}\r\n\r\n.icon-button:hover {\r\n  background: #ebebeb;\r\n}\r\n\r\n.icon-button.selected {\r\n  background: rgba(0, 188, 212, 0.12);\r\n}\r\n\r\n.icon-button.selected:hover {\r\n  background: rgba(0, 188, 212, 0.2);\r\n}\r\n\r\n.align-center {\r\n  margin-left: auto;\r\n  margin-right: auto;\r\n}\r\n\r\n.classroom-container {\r\n  width: 90vw;\r\n  height: 36px;\r\n}\r\n\r\n.video-list {\r\n  width: 100%;\r\n  display: grid;\r\n  grid-template-columns: repeat(1, 1fr);\r\n  gap: 32px 20px;\r\n}\r\n\r\n.video-list.search {\r\n  height: 493px;\r\n  overflow-y: scroll;\r\n}\r\n\r\n.video-item {\r\n  position: relative;\r\n  width: 240px;\r\n  height: 255px;\r\n  align-self: center;\r\n  justify-self: center;\r\n}\r\n\r\n.video-item__thumbnail {\r\n  width: 100%;\r\n  height: 135px;\r\n}\r\n\r\n.video-item__title {\r\n  font-weight: bold;\r\n  font-size: 16px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  margin: 4px 0;\r\n}\r\n\r\n.video-item__channel-name {\r\n  font-size: 16px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n}\r\n\r\n.video-item__published-date {\r\n  font-size: 12px;\r\n  line-height: 24px;\r\n  letter-spacing: 0.5px;\r\n}\r\n\r\n.video-item__save-button {\r\n  position: absolute;\r\n  right: 0;\r\n  width: 80px;\r\n  height: 36px;\r\n  background: #f9f9f9;\r\n  margin-top: 4px;\r\n}\r\n\r\n.video-item__save-button:hover {\r\n  background: #efefef;\r\n}\r\n\r\n@media only screen and (min-width: 400px) {\r\n  .classroom-container {\r\n    width: 368px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 600px) {\r\n  .classroom-container {\r\n    width: 500px;\r\n  }\r\n  .classroom-container__title {\r\n    font-size: 34px;\r\n    margin-bottom: 56px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(2, 1fr);\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 960px) {\r\n  .classroom-container {\r\n    width: 760px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(3, 1fr);\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1280px) {\r\n  .classroom-container {\r\n    width: 1020px;\r\n  }\r\n  .video-list {\r\n    grid-template-columns: repeat(4, 1fr);\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".modal-container {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n}\r\n\r\n.dimmer {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: 100%;\r\n  background: rgba(0, 0, 0, 0.5);\r\n}\r\n\r\n.search-modal {\r\n  position: relative;\r\n  width: 90vw;\r\n  height: 727px;\r\n  background: #ffffff;\r\n  border: 1px solid rgba(0, 0, 0, 0.12);\r\n  border-radius: 4px;\r\n  padding: 50px 30px 32px 30px;\r\n}\r\n\r\n.search-modal__title {\r\n  text-align: center;\r\n  font-weight: bold;\r\n  font-size: 24px;\r\n  line-height: 36px;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.search-input {\r\n  display: flex;\r\n  justify-content: center;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.search-input__keyword {\r\n  width: 60%;\r\n  height: 36px;\r\n  margin-right: 20px;\r\n  padding: 4px 8px;\r\n  border: 1px solid #b4b4b4;\r\n  border-radius: 4px;\r\n}\r\n\r\n.search-input__keyword::placeholder {\r\n  color: #8b8b8b;\r\n  font-size: 16px;\r\n}\r\n\r\n.search-input__search-button {\r\n  width: 72px;\r\n  height: 36px;\r\n  background: #00bcd4;\r\n  color: #ffffff;\r\n}\r\n\r\n.search-result.search-result--no-result {\r\n  height: 493px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n.no-result {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.no-result__image {\r\n  width: 190px;\r\n  height: 140px;\r\n  margin-bottom: 32px;\r\n}\r\n\r\n.no-result__description {\r\n  font-size: 16px;\r\n  line-height: 150%;\r\n  text-align: center;\r\n  letter-spacing: 0.5px;\r\n}\r\n\r\n.skeleton {\r\n  width: 240px;\r\n}\r\n\r\n.skeleton .image,\r\n.skeleton .line {\r\n  background-image: linear-gradient(90deg, #e0e0e0 0px, #ededed 30px, #e0e0e0 60px);\r\n  animation: refresh 2s infinite ease-out;\r\n}\r\n\r\n.skeleton .image {\r\n  height: 135px;\r\n}\r\n\r\n.skeleton .line {\r\n  height: 24px;\r\n  margin: 6px 0;\r\n}\r\n\r\n.skeleton .line:first-child {\r\n  width: 50%;\r\n}\r\n\r\n.skeleton .line:last-child {\r\n  width: 80%;\r\n}\r\n\r\n@keyframes refresh {\r\n  0% {\r\n    background-position: calc(-100px);\r\n  }\r\n  40%,\r\n  100% {\r\n    background-position: 320px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 500px) {\r\n  .search-modal {\r\n    width: 448px;\r\n  }\r\n  .search-input__keyword {\r\n    width: 280px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 600px) {\r\n  .search-modal {\r\n    width: 580px;\r\n  }\r\n  .search-modal__title {\r\n    font-size: 34px;\r\n  }\r\n  .search-input__keyword {\r\n    width: 400px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 960px) {\r\n  .search-modal {\r\n    width: 840px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1280px) {\r\n  .search-modal {\r\n    width: 1100px;\r\n  }\r\n}\r\n\r\n.hide {\r\n  display: none;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/css/modal.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,YAAY;EACZ,aAAa;EACb,eAAe;EACf,MAAM;EACN,OAAO;AACT;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,8BAA8B;AAChC;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,aAAa;EACb,mBAAmB;EACnB,qCAAqC;EACrC,kBAAkB;EAClB,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,eAAe;EACf,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,YAAY;EACZ,kBAAkB;EAClB,gBAAgB;EAChB,yBAAyB;EACzB,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,mBAAmB;EACnB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,kBAAkB;EAClB,qBAAqB;AACvB;;AAEA;EACE,YAAY;AACd;;AAEA;;EAEE,iFAAiF;EACjF,uCAAuC;AACzC;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE;IACE,iCAAiC;EACnC;EACA;;IAEE,0BAA0B;EAC5B;AACF;;AAEA;EACE;IACE,YAAY;EACd;EACA;IACE,YAAY;EACd;AACF;;AAEA;EACE;IACE,YAAY;EACd;EACA;IACE,eAAe;EACjB;EACA;IACE,YAAY;EACd;AACF;;AAEA;EACE;IACE,YAAY;EACd;AACF;;AAEA;EACE;IACE,aAAa;EACf;AACF;;AAEA;EACE,aAAa;AACf","sourcesContent":[".modal-container {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n}\r\n\r\n.dimmer {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: 100%;\r\n  background: rgba(0, 0, 0, 0.5);\r\n}\r\n\r\n.search-modal {\r\n  position: relative;\r\n  width: 90vw;\r\n  height: 727px;\r\n  background: #ffffff;\r\n  border: 1px solid rgba(0, 0, 0, 0.12);\r\n  border-radius: 4px;\r\n  padding: 50px 30px 32px 30px;\r\n}\r\n\r\n.search-modal__title {\r\n  text-align: center;\r\n  font-weight: bold;\r\n  font-size: 24px;\r\n  line-height: 36px;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.search-input {\r\n  display: flex;\r\n  justify-content: center;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.search-input__keyword {\r\n  width: 60%;\r\n  height: 36px;\r\n  margin-right: 20px;\r\n  padding: 4px 8px;\r\n  border: 1px solid #b4b4b4;\r\n  border-radius: 4px;\r\n}\r\n\r\n.search-input__keyword::placeholder {\r\n  color: #8b8b8b;\r\n  font-size: 16px;\r\n}\r\n\r\n.search-input__search-button {\r\n  width: 72px;\r\n  height: 36px;\r\n  background: #00bcd4;\r\n  color: #ffffff;\r\n}\r\n\r\n.search-result.search-result--no-result {\r\n  height: 493px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n.no-result {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.no-result__image {\r\n  width: 190px;\r\n  height: 140px;\r\n  margin-bottom: 32px;\r\n}\r\n\r\n.no-result__description {\r\n  font-size: 16px;\r\n  line-height: 150%;\r\n  text-align: center;\r\n  letter-spacing: 0.5px;\r\n}\r\n\r\n.skeleton {\r\n  width: 240px;\r\n}\r\n\r\n.skeleton .image,\r\n.skeleton .line {\r\n  background-image: linear-gradient(90deg, #e0e0e0 0px, #ededed 30px, #e0e0e0 60px);\r\n  animation: refresh 2s infinite ease-out;\r\n}\r\n\r\n.skeleton .image {\r\n  height: 135px;\r\n}\r\n\r\n.skeleton .line {\r\n  height: 24px;\r\n  margin: 6px 0;\r\n}\r\n\r\n.skeleton .line:first-child {\r\n  width: 50%;\r\n}\r\n\r\n.skeleton .line:last-child {\r\n  width: 80%;\r\n}\r\n\r\n@keyframes refresh {\r\n  0% {\r\n    background-position: calc(-100px);\r\n  }\r\n  40%,\r\n  100% {\r\n    background-position: 320px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 500px) {\r\n  .search-modal {\r\n    width: 448px;\r\n  }\r\n  .search-input__keyword {\r\n    width: 280px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 600px) {\r\n  .search-modal {\r\n    width: 580px;\r\n  }\r\n  .search-modal__title {\r\n    font-size: 34px;\r\n  }\r\n  .search-input__keyword {\r\n    width: 400px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 960px) {\r\n  .search-modal {\r\n    width: 840px;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1280px) {\r\n  .search-modal {\r\n    width: 1100px;\r\n  }\r\n}\r\n\r\n.hide {\r\n  display: none;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
